# Plot4: Nations Favorite Christmas Song
# Author: Gareth Burns
...
# I set the theme elements using theme_update as I intented to share the theme
...
data <- read.csv(file = "charts.csv", stringsAsFactors = TRUE)
